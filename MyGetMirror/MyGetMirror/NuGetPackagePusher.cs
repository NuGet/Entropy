...
namespace MyGetMirror
{
    public class NuGetPackagePusher
    {
        ...
        private readonly string _pushDestination;

        public NuGetPackagePusher(string pushDestination, string destinationApiKey, HttpSource httpSource, ILogger logger)
        {
