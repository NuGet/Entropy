...
namespace WebApplication1.Controllers
{
    public class RequestController : Controller
    {
        ...
        public ActionResult Index2(int statusID = 1, int assignedToFilter = -1, int issueStatusNameFilter = -1, string reasonFilter = "", int page = 0)
        {
            var issues = GetIssues(statusID);
            ...
            {
                this.ViewBag.MaxPage = count / PageSize + 1;
            }
        ...
        private List<SelectListItem> GetListOfAdmins(List<Admin> incoming, int adminToSelect)
        {
            var admins = new List<SelectListItem>();
        ...
        //private void SetTempDataForIndexView(int assignedToFilter, int issueStatusNameFilter, string reason, int statusID, int page)
        //{
        //    TempData["ReasonFilter"] = reason;
        //    TempData["StatusId"] = statusID;
        //    TempData["Page"] = page;
        //    TempData["AssignedToFilter"] = assignedToFilter;
        //    TempData["IssueStatusNameFilter"] = issueStatusNameFilter;
        //}
