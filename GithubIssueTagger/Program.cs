...
namespace GithubIssueTagger
{
    public class Program
    {
        ...
        private static async Task AreaOwnerReport()
        {
            ...
            Console.WriteLine("PM UI\t" + pmuiIssues.Count());
            ...
            Console.WriteLine("PMC\t" + pmcIssues.Count());
            ...
            Console.WriteLine("SDK\t" + sdkIssues.Count());
            ...
            Console.WriteLine("CLI\t" + cliIssues.Count());
            ...
            Console.WriteLine("Pack\t" + packIssues.Count());
            ...
            Console.WriteLine("Push\t" + pushIssues.Count());
            ...
            Console.WriteLine("Restore\t" + restoreIssues.Count());
            ...
            Console.WriteLine("Signing\t" + signingIssues.Count());
            ...
            Console.WriteLine("Package Management\t" + managementIssues.Count());
            ...
            Console.WriteLine("Search & List\t" + searchListIssues.Count());
            ...
            Console.WriteLine("Core\t" + coreIssues.Count());
        }
